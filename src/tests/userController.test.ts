import { getUsers, updateUser, getUserById } from '../controllers/userController';
...
describe('userController', () => {
  ...
  describe('getUsers', () => {
    it('should return filtered list of users', async () => {
      ...
      const fakeUsers = [{ USEN_ID: 1, USEC_LNAME: 'Dupont', USEC_FNAME: 'Jean', USEC_TYPE: 'OWNER' }];
  ...
  describe('getUserById', () => {
    it('should return a single user by ID', async () => {
      ...
      expect(prisma.user.findUnique).toHaveBeenCalledWith({ where: { USEN_ID: 3 } });
